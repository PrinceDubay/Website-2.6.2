...
(function(n, m, k) {
    var d = {
        widgetTitle: "<h3 class='title dt'>Related Posts</h3>",
        widgetStyle: 1,
        homePage: "http://www.princedubay.com",
        numPosts: 7,
        summaryLength: 320,
        titleLength: "auto",
        thumbnailSize: 200,
    ...
    e = (typeof labelArray == "object" && labelArray.length > 0) ? "/-/" + l(labelArray)
    [0] : "",
    h = function(b) {
            ...
            if (A == 2) {
                ...
                if (A == 3) {
                    ...
                    if (A == 4) {
                        ...
                        c += '<li><div class="iF"><div class="pCtnt"><div class="pInr"><div class="iTtl aTtl"><a href="' + v + '" ' + b + '>' + w + '</a></div><div class="pSnpt">' + u + '</div></div></div></div></li>'
                    }
                }
            }
        }
...
(window, document, document.getElementsByTagName("head")
[0]);
